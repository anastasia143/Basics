 ...
 * four-way swap first on the corners, then on the element clockwise from the edges, then on the element
 * three steps away. Once the exterior elements are rotated, we then rotate the interior region’s edges.
**/
