...
/** 9.4 If you have a 2 GB file with one string per line, which
 * sorting algorithm would you use to sort the file and why?
 * ==============================================================
 * When an interviewer gives a size limit of 2GB, it should tell you something - in this case, it suggests
...
1. Divide the file into K chunks, where X * K = 2 GB. Bring each chunk into memory and sort
the lines as usual using any O(n log n) algorithm. Save the lines back to the file.
